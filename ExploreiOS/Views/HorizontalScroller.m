...
// 1 Define constants to make it easy to modify the layout at design time.
#define VIEW_PADDING 10
#define VIEW_DIMENSIONS 100
#define VIEWS_OFFSET 100

// 2 HorizontalScroller conforms to the UIScrollViewDelegate protocol.
...
//scrollViewDidEndDragging:willDecelerate: informs the delegate when the user finishes dragging. The decelerate parameter is true if the scroll view hasn’t come to a complete stop yet.
