...
@interface QuoteQuizViewController ()<QuizTipViewControllerDelegate>
...
- (void)viewDidLoad
{
    ...
    self.quizIndex = 999;
    self.quiz = [[Quiz alloc] initWithQuiz:@"MovieQuotes"];
    [self nextQuizItem];
...
#pragma mark - QuizTipDelegate Methods
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([segue.identifier isEqualToString:@"QuizTipModal"]) {
